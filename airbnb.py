...
import pymongo
# import psycopg2
import mysql.connector  # sas sql # mysql.connector
...
class data_collection:
    ...
    gopi = pymongo.MongoClient("mongodb+srv://jazzoria:root@cluster0.4eyuj8w.mongodb.net/?retryWrites=true&w=majority") 
...
class sql:
    ...
    def create_table():
        gopi = mysql.connector.connect(host='localhost', #psycopg2 mysql.connector
                                user='root',    #postgres
                                password='',
                                database='airbnb')
        cursor = gopi.cursor()
    ...
    def data_migration():
        gopi = mysql.connector.connect(host='localhost', #psycopg2
                                user='root',     #postgres
                                password='',
                                database='airbnb')
        cursor = gopi.cursor()
